...
function interpretBody (body, variableStore, functionStore) {
    ...
    switch(body[0]) {
        case 'Sequence':
            ...
            const stmtAddress = interpretStatement(body[1], variableStore, functionStore);
        ...
        case 'New':
            ...
            // // if the address has changed then change the value in the stack at the current address
            // if (newAddress !== bodyAddress) {
            //     stack[newAddress] = stack[bodyAddress];
            // }
            // // clean up stack after current position
            // stackAddress = newAddress;
            // return newAddress
        default:
